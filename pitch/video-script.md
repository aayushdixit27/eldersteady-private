...
| 2:58–3:28 | One dedicated shot of the live “Before the fall” panel. Burn in: “VALUES · MEASURED LIVE; NO CAPTURE COMMITTED,” “THRESHOLDS · GUESS,” “COMPUTED ON MLA · ONLY NUMBERS LEAVE.” | “A fall alert is table stakes. Watch's product is the numbers before the fall: last sit-to-stand and count, floor-lie now and total, upright, sitting and floor seconds, and company seconds. They are computed on the MLA from keypoints; only numbers leave, on the same ledger and bytes-out counter. The code is on main at commit 1ccc396 and this panel at f15fd04. Values are measured live when running; no trend capture is committed.” |
...
| 4:15–4:30 | Split: generic fall detector versus Watch trend, ledger, and family page. End card: “Watch · care without surveillance.” | “The other fall detector cannot show the week before. Watch can show the numbers without gaining the ability to watch.” |
